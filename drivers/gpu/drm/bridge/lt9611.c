...
static int lt9611_connector_get_modes(struct drm_connector *connector)
{
	...
	drm_edid = drm_edid_read_custom(connector, lt9611_get_edid_block, lt9611);
...
static enum drm_connector_status lt9611_bridge_detect(struct drm_bridge *bridge, struct drm_connector *connector)
{
	struct lt9611 *lt9611 = bridge_to_lt9611(bridge);
	unsigned int reg_val = 0;
	int connected;
...
static const struct drm_edid *lt9611_edid_read(struct lt9611 *lt9611,
						struct drm_connector *connector)
{
	lt9611_power_on(lt9611);
...
{
	struct lt9611 *lt9611 = bridge_to_lt9611(bridge);
	return lt9611_edid_read(lt9611, connector);
}
