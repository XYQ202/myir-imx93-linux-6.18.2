...
enum halmac_drv_rsvd_pg_num {
	...
	HALMAC_RSVD_PG_NUM512,
	HALMAC_RSVD_PG_NUM1024,
	HALMAC_RSVD_PG_NUM1460,
};
...
struct halmac_api {
	...
	//jerry_zhou
	enum halmac_ret_status
	(*halmac_write_logical_efuse_8733B)(struct halmac_adapter *adapter,
